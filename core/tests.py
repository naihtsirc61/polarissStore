...
company = Company()
company.name = 'Polariss SAC'
company.ruc = '0928363993001'
company.email = 'naihtsircnaihtsirc@gmail.com'
company.phone = '2977557'
company.mobile = '925745321'
company.desc = 'Ventas Al Por Mayor Y Por Menor En Productos para el hogar.'
company.website = 'polarissweb.com'
company.address = 'Calle Real N° 142'
company.iva = 18.00
company.save()
