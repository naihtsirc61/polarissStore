var tblPaymentsDebtsPay, tblDebtsPay, debtspay;
var date_current;
var input_daterange;
        ...
        columnDefs: [
            {
                ...
                render: function (data, type, row) {
                    ...
                    buttons += '<a href="/pos/frm/debts/pay/delete/' + row.id + '/" class="btn btn-danger btn-xs btn-flat"><i class="fas fa-trash"></i></a>';
                    return buttons;
                }
            },
            {
    ...
    $('#tblPayments tbody')
        ...
        .on('click', 'a[rel="delete"]', function () {
            ...
            submit_with_ajax('Notificación',
                ...
                function () {
                    tblDebtsPay = tblDebtsPay.ajax.reload();
